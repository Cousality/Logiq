...
<main>
    <section id="Return_policy">
        ...
        <div class="return-section">
            <p>Thank you for choosing LogIQ. We are committed to providing high quality products and a smooth customer experience. Please read our Return Policy carefully to understand how returns, exchanges, and refunds are handled.</p>
        </div>
        ...
        <div class="return-section">
            ...
            <p>If your order arrives damaged, defective, or missing pieces, please notify us within <strong>7 days</strong> of delivery.</p>
        ...
        <div class="return-section">
            ...
            <ul class="lists">
                ...
                <li>Return shipping is covered by LogIQ only if the item arrived damaged, defective, or incorrect.</li>
        ...
        <div class="return-section">
            ...
            <p>Refunds are issued to the original payment method once the returned item has been received and inspected.</p>
            <p>Please allow <strong>3 to 10 business days</strong> for the refund to be processed.</p>
        </div>

        <div class="return-section">
            <h2>Order Cancellations</h2>
            <p>Orders may be cancelled before they are shipped. Once an order has been dispatched, it will fall under our standard return policy.</p>
        </div>


        <div class="return-section">
            <h2>Contact Us</h2>
            <p>If you have questions or wish to return, please <a class="links" href="customer_service">contact us</a>.</p>
