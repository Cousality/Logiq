...
<head>
    ...
    <title>Add Promotion - LOGIQ Admin</title>
...
<body>
    ...
    <header class="dashboard-header">
        <h1 class="dashboard-title">Add Promotion</h1>
        <p>Create a new promotion code.</p>
    </header>
    ...
    <main class="management-container">
        ...
        <div class="settings-card">
            ...
            <form action="{{ route('admin.promotions.store') }}" method="POST" novalidate id="promoForm">
                @csrf
                ...
                <div class="form-row">
                    <div class="form-group">
                        ...
                        <select id="discountType" name="discountType" required>
                            <option value="" disabled {{ old('discountType') ? '' : 'selected' }}>— Select —</option>
                    ...
                    <div class="form-group">
                        ...
                        <input type="number"
                               ...
                               step="0.01"
                               placeholder="0.00">
                        <p class="field-hint" id="valueHint">Enter the discount amount.</p>
                        @error('discountValue')
                            <span class="error">{{ $message }}</span>
                        @enderror
                    </div>
        ...
        (function () {
            ...
            function updateHint() {
                if (typeSelect.value === 'percentage') {
                    ...
                    valueHint.textContent = 'Enter the discount amount.';
                    valueInput.removeAttribute('max');
                }
            }
