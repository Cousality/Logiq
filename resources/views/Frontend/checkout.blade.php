    ...
    <div class="checkout-wrapper">
        ...
        <section class="checkout-main">
            ...
            <div class="section">
                ...
                <!-- PAYPAL BUTTON -->
                <a href="#" class="paypal-btn">Continue with PayPal</a>
            ...
            <form action="{{ route('checkout.store') }}" method="POST">
                ...
                <div class="section">
                    ...
                    <div class="form-group">
                        ...
                        <input id="card_number" name="card_number" maxlength="19" placeholder="4242 4242 4242 4242"
                    ...
                    <div class="form-grid">
                        ...
                        <div class="form-group">
                            <label>CVV</label>
                            <input id="cvv" name="cvv" maxlength="4" placeholder="123" autocomplete="cc-csc"
                                required>
                        </div>
                    </div>
                </div>
